...
insert into ausgabestellen (id, name, ort, strasse, plz, traeger, telefon, hinweis, sortierung) values
  ...
  ('taegliches-brot', 'das tägliche brot', 'St. Josef Kirche',               'Südstraße 84',       '47798', 'das tägliche brot (Kooperation)', '02151602179', 'Eigene Gästekarten · wöchentlich rotierende Startnummern', 2),
